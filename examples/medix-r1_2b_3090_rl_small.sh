...
TRAIN_DATA="${TRAIN_DATA:-../data/medix-rl-data-small/train.parquet}"
VAL_DATA="${VAL_DATA:-../data/medix-rl-data-small/test.parquet}"
...
python3 -m verl.trainer.main \
    ...
    trainer.project_name=medix_rl_small \
    trainer.experiment_name=medix-r1_2b_3090_rl_small \
    ...
    trainer.save_checkpoint_path=./checkpoints/medix-r1-2b-rl-small \
